...
export default function LpLayout({
  ...
  return (
    <>
      ...
      {/* children が各ページ (page.tsx) の内容に置き換わります */}
      {children} 
      
      <Footer />

      {/* lp_kaigo01.html の <aside> (個人情報保護方針モーダル) を移植 */}
      <aside>
        <div className="p-pp lity-hide" id="pp">
          <h2 className="p-pp__title">個人情報保護方針</h2>
          <div className="p-pp__entry">
            <p>
              シューペルブリアン株式会社（以下、当社といいます。）は、取り扱う個人情報を適切に管理することが弊社の事業活動の根幹に関わる責務であると認識し、個人情報の保護に関する方針を次のとおり定め、すべての役員、従業員及び関係スタッフが以下の項目について取り組むべく宣言いたします。
            </p>
            <ul>
            ...
            <p style={{ textAlign: 'center' }}>
              個人情報に関する問い合わせ窓口：個人情報保護管理者<br />担当者：古山 太一<br />〒730-0013　広島市中区八丁堀６番３号　和光八丁堀ビル７階<br />082-962-3100
            </p>
          </div>
          <button className="p-pp__button" type="button" aria-label="Close (Press escape to close)" data-lity-close=""></button>
        </div>
      </aside>
    </>
  );
